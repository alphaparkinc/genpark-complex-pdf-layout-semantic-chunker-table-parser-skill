# genpark-complex-pdf-layout-semantic-chunker-table-parser-skill
...
> **GenPark AI Agent Skill** -- Complex PDF layout semantic chunker & markdown table parser (LlamaParse style)
